...
public class Main
{
    ...
    public static void main(String[] args) {
        ...
        int TCPReceiverPort = 5001;
        // Client Data Receiver for P2P
        try {
            clientThreadIn = new TCPReceiver("Client",TCPReceiverPort);
        ...
        try{
            ...
            InetAddress tarAddress = InetAddress.getByName("10.13.238.21");
            byte[] targetAddress = tarAddress.getAddress();
            RDTSender sender = new RDTSender();
            sender.startSender(targetAddress,4001);   
